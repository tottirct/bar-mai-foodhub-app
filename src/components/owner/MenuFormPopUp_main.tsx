    ...
    <UniversalPopUp isOpen={isOpen} onClose={onClose} title={isEditMode ? "แก้ไขเมนู" : "เพิ่มเมนู"}>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col">
          ...
          />
          {imagePreview ? (
            <div className="relative w-full h-48 rounded-xl overflow-hidden border-2 border-green-200 group">
              <img
                src={imagePreview}
                alt="Preview"
            ...
            <button
              type="button"
              onClick={() => fileInputRef.current?.click()}
              className="w-full h-48 rounded-xl border-2 border-dashed border-gray-300 hover:border-green-400 bg-gray-50 hover:bg-green-50/50 flex flex-col items-center justify-center gap-2 transition-all cursor-pointer"
            >
