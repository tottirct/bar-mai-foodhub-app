...
export default function BanShopModal({
    shop,
    reason,
    setReason,
    isBanning,
            ...
            <div className="relative w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-300">
                <div className="p-8 text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tight">Ban Shop?</h2>
                        <p className="text-gray-400 font-medium tracking-tight">Ban <span className="text-gray-900 font-black">{shop.name}</span>?</p>
                    </div>

                    <div className="text-left mt-6">
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4 mb-2 block tracking-widest">Reason</label>
                        <textarea
